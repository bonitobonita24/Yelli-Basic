  ...
  theme: {
    extend: {
      colors: {
        ...
        // V32.8 additions — missing surface-tier tokens restored from DESIGN.md
        ...
        // V32.8 addition — brand-ochre restored (#e8b94a); coral stays as a separate token
        'brand-ochre': 'var(--color-brand-ochre)',
        'brand-mint': 'var(--color-brand-mint)',
        'brand-coral': 'var(--color-brand-coral)',
        // V32.8 addition — hairline border token
