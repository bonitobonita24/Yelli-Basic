...
- 🚧 Phase 3.3 — IN PROGRESS (Wave 8/N complete, 6 Core User Flows walkable + audit-emit vocabulary §11-canonical + LAN admin gate live + invite flow live, 2026-06-09)
...
- 6 of 9 §3 Core User Flows now walkable: A Calling + B Receive + C Admin-Assigns-Role + D Register-Device + E LAN-Admin-Login + F Invite
