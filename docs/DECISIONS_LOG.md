...
- [v329-compliance · 2026-06-20] q-v329-02 [A/technical] DSR statutory response window defaulted to 15 days (NPC reasonable-period default) — flagged for owner/legal confirmation. `dsr.object`/`dsr.inform` rights left as `// TODO(v329)` (require consent-withdrawal UI + stored privacy-notice versioning, future wire session).
