...
## THE 32 RULES (compact — full details in .ai_prompt/phases.md, other .ai_prompt/ files, and AI/Master_Prompt_v31.md)
...
Rules: 32 active. All 7 detail files on-demand in .ai_prompt/ (phases.md, memory-governance.md, security.md, ui-rules.md, bootstrap.md, scenarios.md, templates.md). LESSONS_REGISTRY.md consulted at work-start/done-claim/failure (Rule 32). Only CLAUDE.md auto-loads (V32.8).
